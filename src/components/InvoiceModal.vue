<template>
  <div @click="checkClick" ref="invoiceWrap" class="invoice-wrap flex flex-column">
    <form @submit.prevent="submitForm" class="invoice-content">
      ...
      <h1 v-if="!editInvoice">New Bill</h1>
      <h1 v-else>Edit Bill</h1>
      ...
      <div class="bill-from flex flex-column">
        ...
        <div class="location-details flex">
          ...
          <div class="input flex flex-column">
            <label for="billerZipCode">Pin Code</label>
      ...
      <div class="invoice-work flex flex-column">
        ...
        <div class="input flex flex-column">
          <label for="paymentTerms">Payment Promise</label>
        ...
        <div class="work-items">
          ...
          <table class="item-list">
            ...
            <tr class="table-items flex" v-for="(item, index) in invoiceItemList" :key="index">
              ...
              <td class="total flex">INR {{ (item.total = item.qty * item.price) }}</td>
      ...
      <div class="save flex">
        ...
        <div class="right flex">
          ...
          <button v-if="!editInvoice" type="submit" @click="publishInvoice" class="purple">Create Bill</button>
          <button v-if="editInvoice" type="sumbit" class="purple">Update Bill</button>
        </div>
      </div>
    </form>
  </div>
